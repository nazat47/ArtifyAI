...
const Pricing = ({ products, mostPopularProduct = "pro" }: PricingProps) => {
  ...
  return (
    <section className="w-full bg-muted flex flex-col items-center justify-center">
      <div className="w-full container py-32 px-6 xs:px-8 sm:px-0 sm:mx-8 lg:mx-auto flex flex-col items-center justify-center space-y-8">
        <div className="text-center flex flex-col items-center justify-center">
          ...
          <p className="text-base text-muted-foreground max-w-3xl">
            Choose an afforadable plan that is packed with the best features for
