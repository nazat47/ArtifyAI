        ...
        <SheetHeader>
          ...
          <ScrollArea className="flex flex-col h-[100vh]">
            ...
            <div className="flex flex-wrap gap-3 mb-32">
              <Badge
                variant={"secondary"}
                className="rounded-full border border-primary/30 px-4 text-sm font-normal max-w-[80%]"
              >
                <span className="text-primary uppercase mr-2 font-semibold">
                  Model ID:
                </span>
                {image.model?.startsWith("nazat47/")
                  ? image.model.split("/")[1].split(":")[0]
                  : image.model}
              </Badge>
              <Badge
                variant={"secondary"}
                className="rounded-full border border-primary/30 px-4 text-sm font-normal"
              >
                <span className="text-primary uppercase mr-2 font-semibold">
                  Aspect Ratio:
                </span>
